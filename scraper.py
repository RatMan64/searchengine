...
headers = "itemName,itemDescription, picture,  Type, Brand, Size, Price, Url, Onsale, discount \n"
...
def grab(Type, items, url, oldsoup):
    ...
    while (url + "?nocache=1&refine.pagenumber=" + str(count)) != "https://www.The-House.com/" + endofitems[0][
        "href"] or isLastPage == True or onlyOnePage == True:
        ...
        for item in items:
            ...
            file.write(
                str(name) + "," + str(itemDesc) + "," + str(picture) + "," + str(Type) + "," + str(brand) + "," + str(
                    size) + "," + str(price) + "," + str(itemUrl) + "," + str(onsale) + "," + str(discount) + "\n")
        if isLastPage == False and onlyOnePage != True:
            count += 1
        if isLastPage == True:
            isLastPage = False
        elif (url + "?nocache=1&refine.pagenumber=" + str(count)) == "https://www.The-House.com/" + endofitems[0]["href"] and onlyOnePage != True:
            isLastPage = True
